...
export default function Stepper({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-2 w-full ${className}`}
      {...rest}
    >
      <div
          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            <div className={`mt-10 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
              {currentStep !== 1 && (
                <button
                  onClick={handleBack}
                  className={`button small duration-350 transition ${
                    currentStep === 1
              ...
              <button
                ...
                className="button primary small duration-350 flex items-center justify-center font-medium tracking-tight transition"
                {...nextButtonProps}
              >
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators = false }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: 'var(--surface-muted)', color: 'var(--color-muted)' },
...
function StepConnector({ isComplete }: StepConnectorProps) {
  ...
  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-black/10 dark:bg-neutral-600">
      <motion.div
